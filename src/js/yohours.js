...
(function (window, $, moment, YoHours, jSmart, Jed, jedGettextParser) {
	...
	/**
	 * Templates
	 * @type {{bootstrap3: {inputGroup: string, dateRangeModal: string, rangeNav: string}, bootstrap4: {inputGroup: string, dateRangeModal: string, rangeNav: string}}}
	 */
	YoHours.templates = {
		bootstrap3: {
...
//				}
	...
	YoHours.view.HoursInputView.prototype.init = function () {
		...
		let $tpl = $(tpl.fetch({prefix: opts.idPrefix}));
