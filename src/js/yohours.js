...
//				}
	...
	YoHours.view.HoursInputView.prototype.init = function () {
		...
		let $tpl = $(tpl.fetch({prefix: opts.idPrefix, icon: YoHours.templates.icon}));
