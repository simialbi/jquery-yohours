...
(function (window, $, moment, YoHours, jSmart, Jed) {
	...
	/**
	 * Templates
	 * @type {iconClock: string, {bootstrap3: {inputGroup: string, dateRangeModal: string, rangeNav: string}, bootstrap4: {inputGroup: string, dateRangeModal: string, rangeNav: string}, bootstrap5: {inputGroup: string, dateRangeModal: string, rangeNav: string}, bootstrap5: {inputGroup: string, dateRangeModal: string, rangeNav: string}}}
	 */
	YoHours.templates = {
	...
	YoHours.view.DateRangeView.prototype.show = function (edit) {
		...
		this._modal.find('.month-dropdown .dropdown-menu a').on('click', function () {
			let $el = $(this), $monthDropdown = $el.closest('.month-dropdown'),
				$btn = $monthDropdown.find('button.dropdown-toggle'),
			...
			if (opts.bootstrapVersion === 'bootstrap4' || opts.bootstrapVersion === 'bootstrap5') {
				$el.addClass('active');
