...
k.fn.yoHours=function(a){this.each(function(){var b=k(this).data("yoHours");if("string"===typeof a&&b)if("function"===typeof b[a])b[a]();else console.error(a+" is not a valid method!");else{b=k.extend({idPrefix:"yh"+ ++c.counter+"_"},c.options,a);var d=b.locale;r.locale(d);void 0===n&&c.locale&&c.locale[d]&&(n=new y({domain:"messages",locale_data:c.locale[d]}));b=new c.ctrl.MainController(this,b);b.init();k(this).data("yoHours",b)}});return this}})(window,jQuery,moment,YoHours,jSmart,Jed);
