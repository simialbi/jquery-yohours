var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(l,k,t){l instanceof String&&(l=String(l));for(var c=l.length,x=0;x<c;x++){var z=l[x];if(k.call(t,z,x,l))return{i:x,v:z}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(l,k,t){l!=Array.prototype&&l!=Object.prototype&&(l[k]=t.value)};
$jscomp.getGlobal=function(l){return"undefined"!=typeof window&&window===l?l:"undefined"!=typeof global&&null!=global?global:l};$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(l,k,t,c){if(k){t=$jscomp.global;l=l.split(".");for(c=0;c<l.length-1;c++){var x=l[c];x in t||(t[x]={});t=t[x]}l=l[l.length-1];c=t[l];k=k(c);k!=c&&null!=k&&$jscomp.defineProperty(t,l,{configurable:!0,writable:!0,value:k})}};
...
h;g++)for(var f=0,v=a[g].length;f<v;f++)0===g&&0===f?a[g][f]&&(d=g,e=f):g===c.DAYS_MAX&&f===v-1?0<=d&&a[g][f]&&b.push(new c.Interval(d,g,e,f)):a[g][f]&&0>d?(d=g,e=f):!a[g][f]&&0<=d&&(0===f?b.push(new c.Interval(d,g-1,e,c.MINUTES_MAX)):b.push(new c.Interval(d,g,e,f-1)),e=d=-1);return b}return this._intervals};c.Week.prototype.getIntervalsDiff=function(a){var b=this.getAsMinutesArray();a=a.getAsMinutesArray();for(var d={open:[],closed:[]},e=-1,g=-1,h,f,v,m=0;m<=c.DAYS_MAX;m++){h=!1;f=0;for(v=d.open.length;f<=
c.MINUTES_MAX;)h?(0===m&&0===f?b[m][f]&&(e=m,g=f):m===c.DAYS_MAX&&f===c.MINUTES_MAX?0<=e&&b[m][f]&&d.open.push(new c.Interval(e,m,g,f)):b[m][f]&&0>e?(e=m,g=f):!b[m][f]&&0<=e&&(0===f?d.open.push(new c.Interval(e,m-1,g,c.MINUTES_MAX)):d.open.push(new c.Interval(e,m,g,f-1)),g=e=-1),f++):(h=b[m][f]?!a[m][f]:a[m][f])?f=0:f++;!h&&-1<e&&(d.open.push(new c.Interval(e,m-1,g,c.MINUTES_MAX)),g=e=-1);h&&-1===e&&v===d.open.length&&(0<d.closed.length&&d.closed[d.closed.length-1].getEndDay()===m-1?d.closed[d.closed.length-
...
};c.OhRule.prototype.addTime=function(a){if(0!==this._time.length&&"off"===this._time[0].get()||this._time.contains(a))throw Error(n.translate("This time can't be added to this rule").withContext("yohours/notifications").fetch());this._time.push(a)};c.OpeningHoursBuilder=function(){};c.OpeningHoursBuilder.prototype.build=function(a){var b=[],d;var e=0;for(var g=a.length;e<g;e++){var h=a[e];if(void 0!==h){var f=d=null;for(var v=e-1;0<=v&&null==d;){if(void 0!==a[v]){var m=a[v].isGeneralFor(h);a[v].hasSameTypical(h)&&
(a[v].getInterval().equals(h.getInterval())||m)?d=v:m&&a[v].definesTypicalWeek()&&h.definesTypicalWeek()&&(f=v)}v--}if(0===e||null==d)for(h=h.definesTypicalWeek()?null!=f?this._buildWeekDiff(h,a[f]):this._buildWeek(h):this._buildDay(h),f=0,v=h.length;f<v;f++){d=h[f];var k=!1;for(m=0;!k&&m<b.length;)if(b[m].sameTime(d))try{for(var u=0,n=d.getDate().length;u<n;u++)b[m].addDate(d.getDate()[u]);k=!0}catch(p){"holiday"===d.getDate()[0].getWideType()&&"PH"===d.getDate()[0].getWideValue()&&"always"===b[m].getDate()[0].getWideType()?
(b[m].addPhWeekday(),k=!0):"holiday"===b[m].getDate()[0].getWideType()&&"PH"===b[m].getDate()[0].getWideValue()&&"always"===d.getDate()[0].getWideType()?(d.addPhWeekday(),b[m]=d,k=!0):m++}else m++;k||b.push(d);if(f===v-1&&d.hasOverwrittenWeekday()){m=new c.OhRule;for(k=0;k<d.getDate().length;k++)m.addDate(new c.OhDate(d.getDate()[k].getWideValue(),d.getDate()[k].getWideType(),d.getDate()[k].getWdOver()));m.addTime(new c.OhTime);h.push(m);v++}}}}a="";m=0;for(g=b.length;m<g;m++)0<m&&(a+="; "),a+=b[m].get();
...
a.getTo())):(f[a.getStartDay()].addTime(new c.OhTime(a.getFrom(),c.MINUTES_MAX)),f[a.getEndDay()].addTime(new c.OhTime(0,a.getTo())));else for(var k=a.getStartDay(),m=a.getEndDay();k<=m;k++)k===a.getStartDay()?f[k].addTime(new c.OhTime(a.getFrom(),c.MINUTES_MAX)):k===a.getEndDay()?f[k].addTime(new c.OhTime(0,a.getTo())):f[k].addTime(new c.OhTime(0,c.MINUTES_MAX))}catch(B){console.warn(B)}}return[g,h,f]};c.OpeningHoursBuilder.prototype._nightMonSun=function(a,b,d){0<=b&&0<=d&&b<d&&(a[0].getTime().sort(this._sortOhTime),
a[6].getTime().sort(this._sortOhTime),a[6].getTime()[a[6].getTime().length-1]=new c.OhTime(d,b),a[0].getTime().shift());return a};c.OpeningHoursBuilder.prototype._sortOhTime=function(a,b){return a.getStart()-b.getStart()};c.OpeningHoursParser=function(){};c.OpeningHoursParser.prototype.parse=function(a){var b=[];a=a.split(";");for(var d,e,g,h,f,k,m,l,u,y,p,w,t=0,x=a.length;t<x;t++)if(d=a[t].trim(),0!==d.length){e=this._tokenize(d);g=e.length-1;h=d=null;0<=g&&this._isRuleModifier(e[g])&&(d=e[g].toLowerCase(),
g--);m=[];if(0<=g&&this._isTime(e[g])){h=e[g];if("24/7"===h)m.push({from:0,to:1440});else for(h=h.split(","),u=0,p=h.length;u<p;u++)f=h[u].split("-"),k=this._asMinutes(f[0]),f=1<f.length?this._asMinutes(f[1]):k,m.push({from:k,to:f});g--}u=[];k=[];if("24/7"===h)k.push({from:0,to:6});else if(0<=g&&this._isWeekday(e[g])){h=e[g];h=h.split(",");p=0;for(f=h.length;p<f;p++)if(l=h[p],c.RGX_HOLIDAY.test(l))u.push(l);else if(c.RGX_WD.test(l)){l=l.split("-");var r=c.OSM_DAYS.indexOf(l[0]);l=1<l.length?c.OSM_DAYS.indexOf(l[1]):
r;k.push({from:r,to:l})}else throw Error(n.translate("Invalid weekday interval: %s").withContext("yohours/notifications").fetch(l));g--}h=[];p=[];if(0<=g){f=e[0];for(r=1;r<=g;r++)f+=" "+e[r];if(0<f.length){f=f.replace(/:$/g,"").split("week");r=f[0].trim();0===r.length&&(r=null);1<f.length?(f=f[1].trim(),0===f.length&&(f=null)):f=null;if(null!=r&&null!=f)throw Error(n.translate("Unsupported simultaneous month and week selector").withContext("yohours/notifications").fetch());if(null!=r){r=r.split(",");
y=0;for(var z=r.length;y<z;y++)if(f=r[y],"SH"===f)p.push({holiday:"SH"});else if(c.RGX_MONTH.test(f)){f=f.split("-");l=c.OSM_MONTHS.indexOf(f[0])+1;if(1>l)throw Error(n.translate("Invalid month: %s").withContext("yohours/notifications").fetch(f[0]));if(1<f.length){if(w=c.OSM_MONTHS.indexOf(f[1])+1,1>w)throw Error(n.translate("Invalid month: %s").withContext("yohours/notifications").fetch(f[1]));}else w=null;p.push({from:l,to:w})}else if(c.RGX_MONTHDAY.test(f)){f=f.replace(/:/g,"").split("-");l=f[0].split(" ");
l={day:parseInt(l[1],10),month:c.OSM_MONTHS.indexOf(l[0])+1};if(1>l.month)throw Error(n.translate("Invalid month: %s").withContext("yohours/notifications").fetch(l[0]));if(1<f.length)if(w=f[1].split(" "),1===w.length)w={day:parseInt(w[0],10),month:l.month};else{if(w={day:parseInt(w[1],10),month:c.OSM_MONTHS.indexOf(w[0])+1},1>w.month)throw Error(n.translate("Invalid month: %s").withContext("yohours/notifications").fetch(w[0]));}else w=null;p.push({fromDay:l,toDay:w})}else throw Error(n.translate("Unsupported month selector: %s").withContext("yohours/notifications").fetch(f));
}else if(null!=f)for(f=f.split(","),l=0,w=f.length;l<w;l++)y=f[l].split("-"),r=parseInt(y[0],10),y=1<y.length?parseInt(y[1],10):null,h.push({from:r,to:y});else throw Error(n.translate("Invalid date selector").withContext("yohours/notifications").fetch());}}if(g===e.length-1)throw Error(n.translate("Unreadable string").withContext("yohours/notifications").fetch());e=[];if(0<p.length)for(h=0,r=p.length;h<r;h++)f=p[h],void 0!==f.holiday?e.push((new c.WideInterval).holiday(f.holiday)):(g=void 0!==f.fromDay?
null!=f.toDay?(new c.WideInterval).day(f.fromDay.day,f.fromDay.month,f.toDay.day,f.toDay.month):(new c.WideInterval).day(f.fromDay.day,f.fromDay.month):null!=f.to?(new c.WideInterval).month(f.from,f.to):(new c.WideInterval).month(f.from),e.push(g));else if(0<h.length)for(p=0,f=h.length;p<f;p++)g=null!=h[p].to?(new c.WideInterval).week(h[p].from,h[p].to):(new c.WideInterval).week(h[p].from),e.push(g);else if(0<u.length)for(g=0,f=u.length;g<f;g++)e.push((new c.WideInterval).holiday(u[g])),"PH"===u[g]&&
0<k.length&&0===p.length&&0===h.length&&e.push((new c.WideInterval).always());else e.push((new c.WideInterval).always());0===k.length&&(0===u.length||1===u.length&&"SH"===u[0]?k.push({from:0,to:c.OSM_DAYS.length-1}):k.push({from:0,to:0}));0===m.length&&m.push({from:0,to:1440});u=0;for(g=e.length;u<g;u++){h=!1;for(p=0;p<b.length&&!h;)b[p].getInterval().equals(e[u])?h=!0:p++;if(h)h=b[p];else{h=new c.DateRange(e[u]);f=-1;for(p=0;p<b.length;p++)b[p].isGeneralFor(new c.DateRange(e[u]))&&(f=p);0<=f&&h.definesTypicalWeek()&&
h.getTypical().copyIntervals(b[f].getTypical().getIntervals());b.push(h)}p=0;for(f=k.length;p<f;p++){if(k[p].from<=k[p].to)r=k[p].from;else{for(r=k[p].from;6>=r;r++)h.definesTypicalWeek()?h.getTypical().removeIntervalsDuringDay(r):h.getTypical().clearIntervals();r=0}for(;r<=k[p].to;r++)h.definesTypicalWeek()?h.getTypical().removeIntervalsDuringDay(r):h.getTypical().clearIntervals();r=0;for(l=m.length;r<l;r++)"closed"===d||"off"===d?this._removeInterval(h.getTypical(),k[p],m[r]):this._addInterval(h.getTypical(),
...
c.ctrl={};c.view={};c.view.DateRangeView=function(a){this._editMode=!1;this._rangeType=null;this._mainView=a;this._modal=null};c.view.DateRangeView.prototype.show=function(a){this._editMode=a||!1;var b=this,d=this._mainView.getController().getOptions();a=new x(c.templates[d.bootstrapVersion].dateRangeModal);this._modal=k(a.fetch({prefix:d.idPrefix,months:c.IRL_MONTHS,editMode:this._editMode,typicalWeek:this._mainView.getCalendarView().getDateRange().definesTypicalWeek(),start:this._mainView.getCalendarView().getDateRange().getInterval().getStart()||
...
"days").add(f.getTo(),"minutes");var m={id:b,start:t().startOf("isoweek").day(1).hour(0).minute(0).second(0).milliseconds(0).add(f.getStartDay(),"days").add(f.getFrom(),"minutes"),end:l};a.push(m)}}b={start:t().startOf("isoweek").day(1).format("YYYY-MM-DD[T00:00:00]"),end:t().startOf("isoweek").day(1).add(7,"days").format("YYYY-MM-DD[T00:00:00]")};g="agendaWeek";f=this._mainView.isMinimal()?"dd":"dddd";l=function(a,b){var d=60*parseInt(a.format("H"),10)+parseInt(a.format("m"),10),f=60*parseInt(b.format("H"),
10)+parseInt(b.format("m"),10),g=A(a.format("d")),k=A(b.format("d"));0===d&&0===f&&1<=k-g&&(f=c.MINUTES_MAX,k--);m={id:h._dateRange.getTypical().addInterval(new c.Interval(g,k,d,f)),start:a,end:b};e.fullCalendar("renderEvent",m,!0);h._mainView.refresh();h.simulateClick()};var n=function(a,b,d,e,f,g){b=60*parseInt(a.start.format("H"),10)+parseInt(a.start.format("m"),10);d=60*parseInt(a.end.format("H"),10)+parseInt(a.end.format("m"),10);e=A(a.start.format("d"));f=A(a.end.format("d"));0===b&&0===d&&
1<=f-e&&(d=c.MINUTES_MAX,f--);h._dateRange.getTypical().editInterval(a.id,new c.Interval(e,f,b,d));h._mainView.refresh()}}else{for(b=0;b<g.length;b++)f=g[b],void 0!==f&&(l=f.getFrom()===f.getTo()?t().hour(0).minute(0).second(0).milliseconds(0).add(f.getTo()+1,"minutes"):t().hour(0).minute(0).second(0).milliseconds(0).add(f.getTo(),"minutes"),m={id:b,start:t().hour(0).minute(0).second(0).milliseconds(0).add(f.getFrom(),"minutes"),end:l},a.push(m));b={start:t().format("YYYY-MM-DD[T00:00:00]"),end:t().add(1,
...
"has-success":"has-error").removeClass(a?"has-error":"has-success")};c.view.HoursInputView.prototype.changedHandler=function(){var a=this._field.caret();this._field.val(this._field.val().replace(/\u00e2\u0090\u00a3/gi," "));this._mainView.getController().showHours(this._field.val());this._field.caret(a)};c.view.HoursInputView.prototype.init=function(){var a=this._mainView.getController().getOptions(),b=new x(c.templates[a.bootstrapVersion].inputGroup),d=this._field.parent();q;a=k(b.fetch({prefix:a.idPrefix,
...
k.fn.yoHours=function(a,b){this.each(function(){var d=k(this).data("yoHours");if("string"===typeof a&&d)if("function"===typeof d[a])if(b&&k.isArray(b))d[a].apply(this,b);else d[a]();else console.error(a+" is not a valid method!");else{d=k.extend({idPrefix:"yh"+ ++c.counter+"_"},c.options,a);var e=d.locale;t.locale(e);b&&"object"===typeof b&&(c.templates=k.extend({},c.templates,b));void 0===n&&c.locale&&c.locale[e]&&(n=new z({domain:"messages",locale_data:c.locale[e]}));d=new c.ctrl.MainController(this,
